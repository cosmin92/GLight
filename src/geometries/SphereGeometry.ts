...
export default class SphereGeometry extends Geometry {
     ...
     */
    public constructor(radius: number = 1, axisDivisions: number = 8, heightDivisions: number = 8, colors?: Float32Array) {
     ...
     * @param {number} heightDivisions
     */
    public static generate(radius: number = 1, axisDivisions: number = 8, heightDivisions: number = 8) {

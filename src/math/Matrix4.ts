...
export default class Matrix4 {
     ...
     * @param {number} a33
     */
    public constructor(a00: number = 1, a01: number = 0, a02: number = 0, a03: number = 0, a10: number = 0, a11: number = 1, a12: number = 0, a13: number = 0, a20: number = 0, a21: number = 0, a22: number = 1, a23: number = 0, a30: number = 0, a31: number = 0, a32: number = 0, a33: number = 1) {
     ...
     * @return {Matrix4}
     */
    public rotate(vector: Vector3): Matrix4 {
     ...
     */
    public copyTo(matrix: Matrix4): void {
     ...
     */
    public static normalMatrix3(matrix: Matrix4): Float32Array {
     ...
     */
    public static rotateX(matrix: Matrix4, degrees: number) {
     ...
     * @param {number} degrees
     */
    public static rotateY(matrix: Matrix4, degrees: number) {
        let out = matrix.getArray();
        let s = Math.sin(degrees * _Math.deg2Rad);
        let c = Math.cos(degrees * _Math.deg2Rad);
     ...
     * @param {number} degrees
     */
    public static rotateZ(matrix: Matrix4, degrees: number) {
     ...
     */
    public static multiply(result: Matrix4, m1: Matrix4, m2: Matrix4) {
        let a = m1.getArray();
        let b = m2.getArray();
     ...
     * @param {number} far
     */
    public static perspective(result: Matrix4, fovy: number, aspect: number, near: number, far: number) {
        let out = result.getArray();
     ...
     * @param {number} far
     */
    public static ortho(result: Matrix4, left: number, right: number, bottom: number, top: number, near: number, far: number) {
        let lr = 1 / (left - right);
        let bt = 1 / (bottom - top);
        let nf = 1 / (near - far);
     ...
     */
    public static targetTo(result: Matrix4, eye: Vector3, target: Vector3, up: Vector3): void {
